var app = new Vue({
    ...
    data: data(),
    created: function () {
        document.getElementById('dataset_identifier').readOnly = true;
    ...
    methods: {
		...
		if(dataset.keywords) {
            ...
            this.$http.post("/api/" + dataset.identifier, dataset).then(function (response) {
                ...
                alert("Failed to update: " + response.body);
                // error callback
				//window.history.back();
            });
            return false;
